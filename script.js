...
$("#searchButton").click(function (event) {
    ...
    const value = $("#cardNumberInput").val();
    if (value == "") {
        return;
    }

    const results = cards.filter(card => card.number == value);
    ...
    $("#cardFactions").text(factions);
    $("#cardText").text(result.text);
    $("#cardTip").text(result.tips);
    $("#cardBackground").text(result.background);
    $("#cardFlavor").text(result.flavor);
    $("#cardNumber").text(value);

    if (result.text_2 != undefined) {
        $("#cardText2").text(result.text_2);
        $("#cardFlavor2").text(result.flavor_2);
        $("#secondVersion").show();
    } else {
        $("#secondVersion").hide();
    }
